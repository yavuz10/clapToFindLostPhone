...
public final class ServiceHandler extends Handler {
    ...
    public Notification initNotification(String str) {
        ...
        contentView.setTextColor(R.id.tvNotificationTitle, ContextCompat.getColor(this, R.color.main_orange));

        Intent notificationIntent = new Intent(this, MainActivity.class);
        @SuppressLint("WrongConstant") PendingIntent pendingIntent = PendingIntent.getActivity(this,
                0, notificationIntent, FLAG_ACTIVITY_NEW_TASK);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, MainActivity.ID);
        builder.setSmallIcon(R.drawable.icon).setOngoing(true).setChannelId(MainActivity.ID).setContentTitle(getResources().getString(R.string.service)).setContentText(str).setVisibility(NotificationCompat.VISIBILITY_PUBLIC).setPriority(2).setContent(contentView).setContentIntent(pendingIntent);
